...
const Footer = () => (
  <>
    ...
    <footer className="flex justify-center items-center bg-[var(--color-turkeyRed-90)]">
      ...
      <section className='container flex flex-wrap flex-col lg:flex-row justify-evenly items-center lg:items-start gap-4 gap-y-4 px-2 py-6 text-[var(--color-whiteSmoke)] text-sm font-medium'>

          <article className="flex flex-col items-center gap-2 p-5 text-sm">
            <img src="../../assets/images/Phoodie_logo.svg" alt="Phởodie logo" className="w-[40px]"></img>
            <span>Phởodie</span>
            <span>© Copyright 2023</span>
          </article>
          <article>
            <h4 className="pb-2 text-center lg:text-start text-lg text-[var(--color-platinum)]">Contact</h4>
            <ul>
          ...
          <article>
            <h4 className="pb-2 text-center lg:text-start text-lg text-[var(--color-platinum)]">Social media</h4>
            <ul>
