      ...
      <nav aria-label="Main Nav" className="navbar-shadow fixed top-0 left-0 w-full h-[var(--navbar-height)] bg-neutral-100/[97] text-[var(--color-wenge)] font-semibold z-50">
        <div className="container mx-auto px-6 py-1 flex justify-between items-center">
          ...
          {currentSection === 0 ? ( // Check is the section is home and render span or Link accordingly
            ...
            >
              {/* <img src="../../assets/images/Phoodie_logo.svg" alt="Phởodie logo" className="w-[62px]"></img> */}
              <svg version="1.1" id="Phởodie logo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 1500 1500"  className="w-[62px] fill-[var(--color-jetBlack)]" xmlSpace="preserve">
                <g>
