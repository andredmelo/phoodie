...
const Home = () => {
  ...
  return (
    <main>
      ...
      >
				<svg id="hill-side-soft-off" className="fill-[var(--color-turkeyRed-90)] h-[20px] md:h-[30px] lg:h-[40px] w-full" preserveAspectRatio="none" viewBox="0 0 1442 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      ...
      <div className="dslc-section-divider dslc-flip-hor dslc-flip-ver" data-divider-pos="top" data-divider-style="hill-side-soft-off">
				<svg id="hill-side-soft-off" className="fill-[var(--color-orangeWeb-90)] w-full h-[20px] md:h-[35px] lg:h-[50px]" preserveAspectRatio="none" viewBox="0 0 1442 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
					<path className="divider-color" d="M1442,30.5019121 L1442,100.654403 L0,100.654403 C572.295431,33.9877365 935.145886,0.654403168 1088.55136,0.654403168 C1162.74657,0.654403168 1280.56278,10.6035728 1442,30.5019121 Z" id="hill-side-soft-off" transform="translate(721.000000, 50.654403) scale(1, -1) translate(-721.000000, -50.654403) "></path>
				</svg>
      </div>
      ...
      >
				<svg id="hill-side-soft" className="fill-[var(--color-orangeWeb-90)] w-full h-[25px] md:h-[45px] lg:h-[80px]" preserveAspectRatio="none" viewBox="0 0 1442 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
